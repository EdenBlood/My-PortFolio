...
export const projects: IProject[] = [
  {
    name: 'Zniply',
    slug: 'zniply',
    smallDescription: 'Gestor de snippets — búsqueda indexada y edición rica',
    description: `
    <p class="mb-4">
    ...
    <p class="mb-2">
      ...
      resaltado), favoritos, landing, tutoriales y página de contacto.
    </p>
    <p class="mb-2">
    ...
    <p class="mb-4">
      Implementé sanitización y validaciones robustas para contenido de usuario,
      manejo de sesiones seguro y una UX pensada en la migración limpia de datos
      de invitado a usuario. Lo desplegué en Vercel (frontend) y dejé el backend
      listo para escalar.
    </p>
  `,
    learnings: `<ul class="list-disc list-inside space-y-2 mb-4">
      ...
      <li class="pl-2">
        Uso avanzado de <strong>TipTap</strong> para edición rica de snippets y manejo de bloques de código con highlighting (Prism/Lowlight).
      </li>
      <li class="pl-2">
  ...
  },
  {
    ...
    url: 'https://up-task-edenblood.vercel.app/',
    id: 1
  },
  {
