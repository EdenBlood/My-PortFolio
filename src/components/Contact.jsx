  ...
  return (
    <>
      ...
      <form
        ...
        className="bg-gray-card p-8 rounded-2xl space-y-4"
      >
        <legend className="text-lg md:text-xl font-semibold mb-10">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="border border-gray-300/30 rounded-md w-full py-1 px-2"
            type="text"
            id="name"
            name="name"
            required
        ...
        <div>
          <input
            type="submit"
            className="block mx-auto cursor-pointer text-center bg-purple-500 hover:bg-purple-700 disabled:bg-purple-500/30 disabled:hover:bg-purple-500/30 disabled:cursor-not-allowed transition-colors duration-300 font-semibold text-white py-3 px-10 rounded-lg"
            disabled={loading}
